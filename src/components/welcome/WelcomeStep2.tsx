    ...
    <>
      ...
      {props.variant === 'active' && (
        <Card className='w-full h-full min-w-[45rem]'>
          <CardHeader>
            <CardTitle className='text-3xl'>2. ¿Qué estás cursando?</CardTitle>
            <CardDescription>
            ...
            <div className='flex flex-row space-x-4'>
              <div className='flex flex-col space-y-4 w-full'>
                <div className='flex flex-col space-y-2'>
                  <WelcomeListItem variant='default' number='1' name='Nombre de la materia' />
                  <WelcomeListItem variant='default' number='1' name='Nombre de la materia' />
                  <WelcomeListItem variant='default' number='1' name='Nombre de la materia' />
                  <WelcomeListItem variant='default' number='2' name='Nombre de la materia' />
                </div>
              </div>
              <div className='flex flex-col space-y-4 w-full'>
                <div className='flex flex-col space-y-2'>
                  <WelcomeListItem variant='selected' number='1' name='Nombre de la materia' />
                </div>
              </div>
            </div>
          </CardContent>
